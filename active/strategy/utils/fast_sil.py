"""
copy from
https://github.com/HazyResearch/hidden-stratification/blob/fc9c9d05d8f96fbfc1badb546a812d6d893c1dc3/stratification/cluster/fast_sil.py#L12
"""
...
from sklearn.metrics.cluster._unsupervised import LabelEncoder, check_number_of_labels, check_X_y
from sklearn.utils import gen_batches, get_chunk_n_rows


def silhouette_samples(X, labels, verbose=False, cuda=torch.cuda.is_available()):
    if not cuda:
